...
client.on("guildMemberAdd", (member) => {
    let canal = client.channels.cache.get('733529611945771069'); 
    canal.send(`Saludos ${member.user}, bienvenido a la aplicación del ${member.guild.name} esperamos una excelente experiencia!`);
   
});

client.on("guildMemberRemove", (member) => {
    let canal = client.channels.cache.get('733529611945771069'); 
    canal.send(`${member.user} ha desinstalado la aplicación ${member.guild.name}, esperamos que hayas tenido una excelente experiencia.`);
